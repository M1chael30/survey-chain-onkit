...
export default function Navbar() {
 ...
 return (
  <div>
   <nav className="border-b border-border/40 bg-background/80 dark:bg-background/60 backdrop-blur-xl supports-[backdrop-filter]:bg-background/60 sticky top-0 z-50 shadow-sm py-4">
     ...
     <div className="flex items-center justify-between h-16">
      <div className="flex items-center gap-8">
       <Link href="/" className="font-bold text-xl">
        ...
        >
         <img
          src="/survey_chain_logo.svg"
          alt="survey_chain_logo"
